...
CREATE TABLE Movimiento(
 ...
 Unidad NVARCHAR(10) NOT NULL,
 Fecha DATETIME NOT NULL DEFAULT(GETDATE()),
 UsuarioId UNIQUEIDENTIFIER NULL REFERENCES [Usuario](Id), -- Foreign Key añadida
...
CREATE TABLE [UserRole](
 ...
 AsignadoPorUsuarioId UNIQUEIDENTIFIER NULL REFERENCES [Usuario](Id), -- Foreign Key añadida
